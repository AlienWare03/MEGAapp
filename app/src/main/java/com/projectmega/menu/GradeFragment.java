...
public class GradeFragment extends Fragment {
    ...
    private List<GradeSubjectList> listGradeSubjects;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        //user = accountList.getUser();

        swipeContainer = (SwipeRefreshLayout) v.findViewById(R.id.swipe_containerGradeSubject);
        ...
        //Initializing Views
        recyclerView = (RecyclerView) v.findViewById(R.id.recyclerViewGradeSubject);
        ...
        listGradeSubjects = new ArrayList<>();
        ...
        adapter = new GradeSubjectAdapter(listGradeSubjects, getActivity().getApplicationContext());
        ...
        recyclerView.addOnItemTouchListener(new RecyclerView.OnItemTouchListener() {
            ...
            public boolean onInterceptTouchEvent(RecyclerView rv, MotionEvent e) {
                ...
                if (child != null && mGestureDetector.onTouchEvent(e)) {
                    ...
                    editor.putInt(Config.SUBJECT1, itemposition);
                    editor.apply();
    ...
    private void parseData(JSONArray array) {
        for (int i = 0; i < array.length(); i++) {
            ...
            GradeSubjectList gradesubject = new GradeSubjectList();
            JSONObject json = null;
            try {
                //Getting json
                json = array.getJSONObject(i);
                //Adding data to the subjectlist object
                gradesubject.setSubjectName(json.getString(Config.TAG_SUBJECT));

            } catch (JSONException e) {
                e.printStackTrace();
            }
            //Adding the subject object to the list
            listGradeSubjects.add(gradesubject);
        }
